...
set(get(AX(1),'Ylabel'),'String','Mixing ratio (ppbv)','FontSize',fsize,'Color',[0 0 0],'FontName','Arial')
set(get(AX(2),'Ylabel'),'String','Tot. Aerosol Mass (\mug m^{-3})','FontSize',fsize,'Color',[0 0 0],'FontName','Arial')
...
set(H1,'Color',[0 0 0],'Marker','o','LineStyle','none','linewidth',1.5,'MarkerSize',4.1)
set(H2,'LineStyle','--' ,'Color',[0 0 1],'LineWidth',1.5,'Marker','o','MarkerSize',4.1)
...
set(AX(1),'linewidth',1.5,'fontsize',fsize,'YColor',[0 0 0])
set(AX(2),'linewidth',1.5,'fontsize',fsize,'YColor',[0 0 0])
set(get(AX(1),'Ylabel'),'String','O_3, NO, NO_2 (ppb)','FontSize',fsize,'Color',[0 0 0],'FontName','Arial')
set(get(AX(2),'Ylabel'),'String','Photol. Frequency j(NO_2)*1E3 (s^{-1})','FontSize',fsize,'Color',[0 0 0],'FontName','Arial')
xlabel('Time UTC (hrs)','FontSize',fsize)
title('11.05.2009 MEA+OH Exp','FontSize',fsize)
legend('O3 meas.','NO meas.','NO2 meas.','O3 mod','NO mod','NO2 mod','Location','NorthEast')
tx=10.0:1:15.0;
set(AX(1),'xtick',tx);
set(AX(2),'xtick',tx);
set(AX(1),'XTickLabel',{'10:00','11:00','12:00','13:00','14:00','15:00'});
...
set(H2,'LineStyle','-' ,'Color',[.6 .6 .6],'LineWidth',2.1)
%uncomment below line to save as jpg
