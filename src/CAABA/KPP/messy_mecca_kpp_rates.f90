...
! RCONST(2477) = constant rate coefficient
  ...
  RCONST(2572) = (xaer(01)*k_arr(8.61E8,-2600.,temp)*cvfac(01))
  RCONST(2573) = (xaer(01)*1.9E10*cvfac(01))
  RCONST(2574) = (xaer(01)*k_arr(6.65E9,-1270.,temp)*cvfac(01))
  RCONST(2575) = (xaer(01)*3.5E7*cvfac(01))
  RCONST(2576) = (xaer(01)*6.0E9*cvfac(01))
  RCONST(2577) = (xnom7nox*k_exf(01,ind_N2O3))
  RCONST(2578) = (xnom7nox*k_exb(01,ind_N2O3))
  RCONST(2579) = (xnom7nox*k_exf(01,ind_N2O4))
  RCONST(2580) = (xnom7nox*k_exb(01,ind_N2O4))
  RCONST(2581) = (xnom7amin*k_exf(01,ind_MMA))
  RCONST(2582) = (xnom7amin*k_exb(01,ind_MMA))
  RCONST(2583) = (xnom7nno*k_exf(01,ind_MMNNO2))
  RCONST(2584) = (xnom7nno*k_exb(01,ind_MMNNO2))
  RCONST(2585) = (xnom7amin*k_exf(01,ind_HNCO))
  RCONST(2586) = (xnom7amin*k_exb(01,ind_HNCO))
  RCONST(2587) = (xnom7amin*k_exf(01,ind_H2NCHO))
  RCONST(2588) = (xnom7amin*k_exb(01,ind_H2NCHO))
  RCONST(2589) = (xnom7co2*k_exf(01,ind_HOCH2CHO))
  RCONST(2590) = (xnom7co2*k_exb(01,ind_HOCH2CHO))
  RCONST(2591) = (xnom7co2*k_exf(01,ind_HOCH2CO2H))
  RCONST(2592) = (xnom7co2*k_exb(01,ind_HOCH2CO2H))
  RCONST(2593) = (xnom7co2*k_exf(01,ind_HCOCO2H))
  RCONST(2594) = (xnom7co2*k_exb(01,ind_HCOCO2H))
  RCONST(2595) = (xnom7co2*k_exf(01,ind_GLYOX))
  RCONST(2596) = (xnom7co2*k_exb(01,ind_GLYOX))
  RCONST(2597) = (xnom7amin*k_exf(01,ind_DMA))
  RCONST(2598) = (xnom7amin*k_exb(01,ind_DMA))
  RCONST(2599) = (xnom7amin*k_exf(01,ind_MEA))
  RCONST(2600) = (xnom7amin*k_exb(01,ind_MEA))
  RCONST(2601) = (xnom7nno*k_exf(01,ind_MEANNO))
  RCONST(2602) = (xnom7nno*k_exb(01,ind_MEANNO))
  RCONST(2603) = (xnom7nno*k_exf(01,ind_MEANNO2))
  RCONST(2604) = (xnom7nno*k_exb(01,ind_MEANNO2))
  RCONST(2605) = (xnom7nno*k_exf(01,ind_NDMA))
  RCONST(2606) = (xnom7nno*k_exb(01,ind_NDMA))
  RCONST(2607) = (xnom7nno*k_exf(01,ind_DMNNO2))
  RCONST(2608) = (xnom7nno*k_exb(01,ind_DMNNO2))
  RCONST(2609) = (xnom7amin*k_exf(01,ind_H2NCOCH2OH))
  RCONST(2610) = (xnom7amin*k_exb(01,ind_H2NCOCH2OH))
  RCONST(2611) = (xnom7amin*k_exf(01,ind_CH3NHCHO))
  RCONST(2612) = (xnom7amin*k_exb(01,ind_CH3NHCHO))
  RCONST(2613) = (xnom7co2*k_exf(01,ind_MGLYOX))
  RCONST(2614) = (xnom7co2*k_exb(01,ind_MGLYOX))
  RCONST(2615) = (xnom7co2*k_exf(01,ind_MGLYOAC))
  RCONST(2616) = (xnom7co2*k_exb(01,ind_MGLYOAC))
  RCONST(2617) = (xnom7amin*k_exf(01,ind_TMA))
  RCONST(2618) = (xnom7amin*k_exb(01,ind_TMA))
  RCONST(2619) = (xnom7amin*k_exf(01,ind_DMNCHO))
  RCONST(2620) = (xnom7amin*k_exb(01,ind_DMNCHO))
  RCONST(2621) = (xnom7amin*k_exf(01,ind_DEA))
  RCONST(2622) = (xnom7amin*k_exb(01,ind_DEA))
  RCONST(2623) = (xnom7nno*k_exf(01,ind_NDELA))
  RCONST(2624) = (xnom7nno*k_exb(01,ind_NDELA))
  RCONST(2625) = (xnom7nno*k_exf(01,ind_DEANNO2))
  RCONST(2626) = (xnom7nno*k_exb(01,ind_DEANNO2))
  RCONST(2627) = (xnom7co2*k_exf(01,ind_BSOV))
  RCONST(2628) = (xnom7co2*k_exb(01,ind_BSOV))
  RCONST(2629) = (xnom7amin*k_exf(01,ind_TEA))
  RCONST(2630) = (xnom7amin*k_exb(01,ind_TEA))
  RCONST(2631) = (xnom7co2*k_exf(01,ind_BLOV))
  RCONST(2632) = (xnom7co2*k_exb(01,ind_BLOV))
  RCONST(2633) = (xnom7dmso*k_exf(01,ind_CH3SOOH))
  RCONST(2634) = (xnom7dmso*k_exb(01,ind_CH3SOOH))
  RCONST(2635) = (xaer(01)*testfac_GLYOAC*6.6E-4)
  RCONST(2636) = (xaer(01)*testfac_GLYOAC*1.E0*cvfac(01))
  RCONST(2637) = (xaer(01)*testfac_MGLYOAC*4.07E-3)
  RCONST(2638) = (xaer(01)*testfac_MGLYOAC*1.E0*cvfac(01))
  RCONST(2639) = (xaer(01)*testfac_OXALAC*6.4E-2)
  RCONST(2640) = (xaer(01)*testfac_OXALAC*1.E0*cvfac(01))
  RCONST(2641) = (xaer(01)*testfac_HC2O4m*5.25E-5)
  RCONST(2642) = (xaer(01)*testfac_HC2O4m*1.E0*cvfac(01))
  RCONST(2643) = (xaer(01)*testfac_SUCCAC*6.4E-2)
  RCONST(2644) = (xaer(01)*testfac_SUCCAC*1.E0*cvfac(01))
  RCONST(2645) = (xaer(01)*testfac_C2H5C2O4m*5.25E-5)
  RCONST(2646) = (xaer(01)*testfac_C2H5C2O4m*1.E0*cvfac(01))
  RCONST(2647) = (xaer(01)*3.5E-4*xaeq(01))
  RCONST(2648) = (xaer(01)*1.60E7*cvfac(01)*xaeq(01))
  RCONST(2649) = (xaer(01)*3.5E-4*xaeq(01))
  RCONST(2650) = (xaer(01)*1.88E7*cvfac(01)*xaeq(01))
  RCONST(2651) = (xaer(01)*3.5E-4*xaeq(01))
  RCONST(2652) = (xaer(01)*2.01E6*cvfac(01)*xaeq(01))
  RCONST(2653) = (xaer(01)*3.5E-4*xaeq(01))
  RCONST(2654) = (xaer(01)*8.79E5*cvfac(01)*xaeq(01))
  RCONST(2655) = (xaer(01)*3.5E-4*xaeq(01))
  RCONST(2656) = (xaer(01)*2.98E5*cvfac(01)*xaeq(01))
  RCONST(2657) = (xaer(01)*3.5E-4*xaeq(01))
  RCONST(2658) = (xaer(01)*2.11E4*cvfac(01)*xaeq(01))
  RCONST(2659) = (xaer(01)*3.0E6*xaeq(01))
  RCONST(2660) = (xaer(01)*1.2E10*cvfac(01)*xaeq(01))
  RCONST(2661) = (xaer(01)*3.5E1*xaeq(01))
  RCONST(2662) = (xaer(01)*2.00E9*cvfac(01)*xaeq(01))
  RCONST(2663) = (xaer(01)*3.0E6*xaeq(01))
  RCONST(2664) = (xaer(01)*1.2E10*cvfac(01)*xaeq(01))
  RCONST(2665) = (xaer(01)*3.5E1*xaeq(01))
  RCONST(2666) = (xaer(01)*2.00E9*cvfac(01)*xaeq(01))
  RCONST(2667) = (xaer(01)*3.0E6*xaeq(01))
  RCONST(2668) = (xaer(01)*1.2E10*cvfac(01)*xaeq(01))
  RCONST(2669) = (xaer(01)*3.5E1*xaeq(01))
  RCONST(2670) = (xaer(01)*2.00E9*cvfac(01)*xaeq(01))
  RCONST(2671) = (xaer(01)*3.0E6*xaeq(01))
  RCONST(2672) = (xaer(01)*1.2E10*cvfac(01)*xaeq(01))
  RCONST(2673) = (xaer(01)*3.5E1*xaeq(01))
  RCONST(2674) = (xaer(01)*2.00E9*cvfac(01)*xaeq(01))
  RCONST(2675) = (xaer(01)*3.0E6*xaeq(01))
  RCONST(2676) = (xaer(01)*1.2E10*cvfac(01)*xaeq(01))
  RCONST(2677) = (xaer(01)*3.5E1*xaeq(01))
  RCONST(2678) = (xaer(01)*2.00E9*cvfac(01)*xaeq(01))
  RCONST(2679) = (xaer(01)*3.0E6*xaeq(01))
  RCONST(2680) = (xaer(01)*1.2E10*cvfac(01)*xaeq(01))
  RCONST(2681) = (xaer(01)*3.5E1*xaeq(01))
  RCONST(2682) = (xaer(01)*2.00E9*cvfac(01)*xaeq(01))
  RCONST(2683) = (xaer(01)*2.0E-4*xaeq(01))
  RCONST(2684) = (xaer(01)*1.E0*cvfac(01)*xaeq(01))
  RCONST(2685) = (xaer(01)*jx(ip_H2O2)*7.11E-1)
  RCONST(2686) = (xaer(01)*jx(ip_NO2O)*1.91E-6)
  RCONST(2687) = (xaer(01)*jx(ip_NO2)*2.50E-3)
  RCONST(2688) = (xaer(01)*jx(ip_NO2)*5.3E-3*xaqcnno)
  RCONST(2689) = (xaer(01)*jx(ip_NO2)*5.3E-3*xaqcnno)
  RCONST(2690) = (xaer(01)*jx(ip_NO2)*1.30E-1*xaqcnno)
  RCONST(2691) = (xaer(01)*jx(ip_NO2)*5.3E-3*xaqcnno)
  RCONST(2692) = (xaer(01)*jx(ip_NO2)*1.30E-1*xaqcnno)
  RCONST(2693) = (xaer(01)*jx(ip_NO2)*5.3E-2*xaqcnno)
  RCONST(2694) = (xaer(01)*jx(ip_NO2)*5.3E-3*xaqcnno)
